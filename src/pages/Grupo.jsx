    ...
    <>
      ...
      <div className="Container-grp2">
        <p>
          ...
          aos professores Antônio e Leandro por esta atividade que foi proposta.
          Durante o processo de criação do site, diversos pontos do grupo foram
          melhorados, tendo como mais importante o trabalho em equipe. Essa
          atividade foi de grande importância para nossa aprendizagem e estudo
          de conteúdos de desenvolvimento de sistemas.
        </p>
        <p>
          O grupo 2 reitera sua gratidão pelo trabalho proposto pelos
          profissionais do ensino, em prol de obtermos conhecimento. Gratos!
        </p>
      </div>
